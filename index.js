...
nocache('../nicky.js', module => console.log(color('[ CHANGE ]', 'green'), color(`'${module}'`, 'green'), 'Updated'))
...
async function XeonBotIncBot() {
	...
	const {  saveCreds, state } = await useMultiFileAuthState(`./${sessionName}`)
        ...
        browser: [`Queen Nicky`,'Safari','3.0'],
...
╎
╎▷ɢʀᴏᴜᴘ ᴍᴇᴍʙᴇʀꜱ : *${xmembers}th*
╎
╎▷ᴊᴏɪɴᴇᴅ ᴛɪᴍᴇ : *${xtime}*
╎▷ᴛᴏᴅᴀʏ ɪꜱ *${xdate}*
╰╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌
ᴘᴏᴡᴇʀᴇᴅ ʙʏ ǫᴜᴇᴇɴ ɴɪᴄᴋʏ ᴡᴀ ʙᴏᴛ`
