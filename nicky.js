...
case 'menu': {
    XeonBotInc.sendMessage(from, { react: { text: "📃", key: m.key }})
            ...
            menumsg = `╭─────────●●▷
│──❬🧞‍♂️ǫᴜᴇᴇɴ-ɴɪᴄᴋʏ ᴍᴅ ʙᴏᴛ🧞‍♂️❭
│    ─────────────
│▸ *🧞‍♂️ʜɪ ${pushname}*
│▸ *🧞‍♂️ʟᴀᴛᴇɴᴄʏ : ${latensie.toFixed(4)} ᴍꜱ*
│▸ *🧞‍♂️ʀᴜɴ ᴛɪᴍᴇ : ${runtime(process.uptime())}*
│▸ *🧞‍♂️ᴘʀᴇꜰɪx : [ . ]*
│▸ *🧞‍♂️ᴠᴇʀꜱɪᴏɴ : ᴠ1*
│▸ *🧞‍♂️ᴄᴏᴅᴇᴅ ʙʏ : ᴋɪɴᴅ ᴀʟᴘʜᴀ*
│▸ *🧞‍♂️ᴏᴡɴᴇʀ : ᴅᴜᴍɪᴅᴜ*
│▸ *🧞‍♂️ᴘʟᴀᴛꜰᴏʀᴍ : ʟɪɴᴜx*
│▸ *🧞‍♂️ᴛᴏᴛᴀʟ ᴏꜰ ᴄᴏᴍᴍᴀɴᴅꜱ :*
╰─────────●●▷
...
╰─────────●●▷`
            let buttonMessage = {
                    image: fs.readFileSync('./src/main.jpg'),
                    caption: menumsg,
                    footer: 'ᴘᴏᴡᴇʀᴇᴅ ʙʏ ǫᴜᴇᴇɴ-ɴɪᴄᴋʏ ᴍᴅ ʙᴏᴛ',
                    headerType: 4
                }
...
case 'yts': case 'ytsearch': {
                ...
                if (!text) return replygcxeon(`*🔎ᴡʜᴀᴛ ᴅᴏ ʏᴏᴜ ᴡᴀɴᴛ ᴛᴏ ꜱᴇᴀʀᴄʜ ɪɴ ʏᴏᴜᴛᴜʙᴇ*`)

                let yts = require("yt-search")

                let search = await yts(text)

                let teks = '*ʀᴇꜱᴜᴀʟᴛ'+text+*'\n\n'
...
case 'play':  case 'song': {
  if (!text) return reply(`🎶 ᴇɴᴛᴇʀ ᴀ ꜱᴏɴɢ ɴᴀᴍᴇ`);
  XeonBotInc.sendMessage(from, { react: { text: "🎶", key: m.key }});
...
if (args.length < 1 || !isUrl(text) || !xeonvidoh.isYTUrl(text)) reply(`*🎬 ᴇɴᴛᴇʀ ᴀ ᴠɪᴅᴇᴏ ʟɪɴᴋ*\n*ʜᴏᴡ ᴛᴏ ɢᴇᴛ ᴠɪᴅᴇᴏ ʟɪɴᴋ: ɴᴏᴡ ʏᴏᴜ ᴜꜱᴇ .ʏᴛꜱ ᴄᴏᴍᴍᴀɴᴅ ꜰᴏʀ ɢᴇᴛ ʏᴏᴜᴛᴜʙᴇ ᴠɪᴅᴇᴏ ʟɪɴᴋ*`)

const vid=await xeonvidoh.mp4(text)

const ytc=`𝙶𝙴𝙽𝙴𝚁𝙰𝚃𝙴𝙳 𝙱𝚈 𝚀𝚄𝙴𝙴𝙽-𝙽𝙸𝙲𝙺𝚈 𝙼𝙳 𝙱𝙾𝚃 📡`
